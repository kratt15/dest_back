...
class ProviderFormRequest extends FormRequest
{
    ...
    {
        return [
            'name_provider' => ['required', 'string', 'max:70'],
            'name_resp' => ['required', 'string', 'max:70'],
            'address_provider' => ['required', 'string', 'max:200'],
            'phone_provider' => [
                'required',
                'string',
                'regex:/^\+?[0-9]+$/',
    ...
    public function messages(): array
    {
        return [
            ...
            'address_provider.max' => "L'adresse du fournisseur ne doit pas dépasser 200 caractères.",
